...
var grammar = {
    ...
    {"name": "element_assignment$ebnf$2$subexpression$1", "symbols": ["__", "range"]},
    ...
    {"name": "element_assignment", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", {"literal":"new"}, "element_assignment$ebnf$1", "__", "elementType", "__", {"literal":"in"}, "__", (lexer.has("identifier") ? {type: "identifier"} : identifier), "element_assignment$ebnf$2"], "postprocess": 
        (data) => {
          return {
    ...
    {"name": "element_assignment$ebnf$3$subexpression$1", "symbols": ["__", (lexer.has("number") ? {type: "number"} : number)]},
    {"name": "element_assignment$ebnf$3", "symbols": ["element_assignment$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "element_assignment$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "element_assignment", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", {"literal":"new"}, "element_assignment$ebnf$3", "__", "elementType", "__", {"literal":"in"}, "__", (lexer.has("identifier") ? {type: "identifier"} : identifier), "__", {"literal":"apply"}, "__", "element_assignment$subexpression$1"], "postprocess": 
        (data) => ({
    ...
    {"name": "range", "symbols": [{"literal":"["}, "_", "position_list", "_", {"literal":"]"}], "postprocess": data => data[2]},
    {"name": "position$subexpression$1", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "position$subexpression$1", "symbols": [(lexer.has("number") ? {type: "number"} : number), "_", {"literal":"-"}, "_", (lexer.has("number") ? {type: "number"} : number)]},
    {"name": "position", "symbols": ["position$subexpression$1"], "postprocess":  
        data => {
          if(data[0].length === 0) return data[0].filter(e => !e.forEach).map(e => e.value)
          return data[0].filter(e => !e.forEach).join('')
        }
        },
    {"name": "position_list$ebnf$1", "symbols": []},
    {"name": "position_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "position"]},
    {"name": "position_list$ebnf$1", "symbols": ["position_list$ebnf$1", "position_list$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "position_list", "symbols": ["position", "position_list$ebnf$1"], "postprocess":  data => {
