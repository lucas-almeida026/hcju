...
var grammar = {
    ...
    {"name": "range", "symbols": [{"literal":"["}, "_", "static_position_list", "_", {"literal":"]"}], "postprocess": data => data[2]},
    {"name": "static_position", "symbols": [(lexer.has("number") ? {type: "number"} : number)], "postprocess": data => data[0].value.toString()},
    {"name": "static_position_list$ebnf$1", "symbols": []},
    {"name": "static_position_list$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "static_position"]},
    {"name": "static_position_list$ebnf$1", "symbols": ["static_position_list$ebnf$1", "static_position_list$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "static_position_list", "symbols": ["static_position", "static_position_list$ebnf$1"], "postprocess": data => [data[0], ...data[1].map(e => e[3])].join(',')},
